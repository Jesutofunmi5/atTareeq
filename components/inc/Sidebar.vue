...
<div class="sidebar" id="settings">
    ...
    <div class="sidebar-action">
        <nuxt-link to="/" class="btn btn-primary"> All Settings </nuxt-link>
    </div>
</div>
...
<div class="sidebar" id="search">
    ...
    <div class="sidebar-content">
        ...
        <div class="mb-4">
            <div class="d-flex align-items-center mb-3">
                <nuxt-link to="/" class="avatar avatar-sm me-3">
                        <span class="avatar-text rounded-circle">
                            <i class="bi bi-search"></i>
                        </span>
                </nuxt-link>
                <nuxt-link to="/" class="flex-fill">Reports for 2021</nuxt-link>
                <nuxt-link to="/" class="btn text-danger btn-sm" data-bs-toggle="tooltip" title="Remove">
                    <i class="bi bi-x"></i>
                </nuxt-link>
            </div>
            <div class="d-flex align-items-center mb-3">
                ...
                <nuxt-link to="/" class="flex-fill">Current users</nuxt-link>
                <nuxt-link to="/" class="btn" data-bs-toggle="tooltip" title="Remove">
                    <i class="bi bi-x"></i>
                </nuxt-link>
            </div>
            <div class="d-flex align-items-center mb-3">
                ...
                <nuxt-link to="/" class="flex-fill">Meeting notes</nuxt-link>
                <nuxt-link to="/" class="btn" data-bs-toggle="tooltip" title="Remove">
                    <i class="bi bi-x"></i>
                </nuxt-link>
            </div>
        ...
        <div class="mb-4">
            <div class="d-flex align-items-center mb-3">
                <nuxt-link to="/" class="avatar avatar-secondary avatar-sm me-3">
                        <span class="avatar-text rounded-circle">
                            <i class="bi bi-check-circle"></i>
                        </span>
                </nuxt-link>
                <nuxt-link  to="/" class="flex-fill">Todo list</nuxt-link>
                <nuxt-link to="/" class="btn" data-bs-toggle="tooltip" title="Remove">
                    <i class="bi bi-x"></i>
                </nuxt-link>
            </div>
            <div class="d-flex align-items-center mb-3">
                <nuxt-link to="/" class="avatar avatar-warning avatar-sm me-3">
                        <span class="avatar-text rounded-circle">
                            <i class="bi bi-wallet2"></i>
                        </span>
                </nuxt-link>
                <nuxt-link to="/" class="flex-fill">Pricing table</nuxt-link>
                <nuxt-link to="/" class="btn" data-bs-toggle="tooltip" title="Remove">
                    <i class="bi bi-x"></i>
                </nuxt-link>
            </div>
            <div class="d-flex align-items-center mb-3">
                <nuxt-link to="/" class="avatar avatar-info avatar-sm me-3">
                        <span class="avatar-text rounded-circle">
                            <i class="bi bi-gear"></i>
                        </span>
                </nuxt-link>
                <nuxt-link to="/" class="flex-fill">Settings</nuxt-link>
                <nuxt-link to="/" class="btn" data-bs-toggle="tooltip" title="Remove">
                    <i class="bi bi-x"></i>
                </nuxt-link>
            </div>
            <div class="d-flex align-items-center mb-3">
                <nuxt-link to="/" class="avatar avatar-success avatar-sm me-3">
                        <span class="avatar-text rounded-circle">
                            <i class="bi bi-person-circle"></i>
                        </span>
                </nuxt-link>
                <nuxt-link to="/" class="flex-fill">Users</nuxt-link>
                <nuxt-link to="/" class="btn" data-bs-toggle="tooltip" title="Remove">
                    <i class="bi bi-x"></i>
                </nuxt-link>
            </div>
    ...
    <div class="sidebar-action">
        <nuxt-link to="/" class="btn btn-danger">All Clear</nuxt-link>
    </div>
</div>
  </div>
</template>
...
<script>
import Notification from '~/components/inc/Notification.vue';
export default {
    data() {
    return {
