                    ...
                    <div class="row">
                            ...
                            <div class="slick-wrapper">
                                <div class="slider-for mb-3">
                                    <div class="slick-slide-item">
                                        <img :src=appLogo style="height:250px; width:100px" class="w-100 rounded"
                                             alt="image">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7">
                            <div class="d-flex justify-content-between align-items-start mt-4 mt-md-0">
                                <div>
                                    <div class="small text-muted mb-2">{{ message.name}}</div>
                                    <h2>{{ message.name}}</h2>
                                    <template>
                                    <p>
...
export default {
 ...
 data() {
    ...
    asyncData({$axios, route}) {
      return $axios.$get(`/categories/${route.params.category}`).then(res=> {
           return {
