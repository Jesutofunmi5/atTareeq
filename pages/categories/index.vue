    ...
    <div class="content">
      ...
      <div class="table-responsive">
        <table class="table table-custom table-lg mb-0" id="customers">
          ...
          <tbody>
            <tr v-for="(category, index) in Categories.slice(0,10)" :key="category._id">
              <td>
                ...
                <div class="d-flex">
                  <div class="dropdown ms-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      <nuxt-link
                       :to="`categories/${category._id}`"  class="dropdown-item">Show</nuxt-link>
                       <nuxt-link :to="`categories/${category._id}`"  class="dropdown-item">Edit</nuxt-link>
                      <span
                        @click="_category(category._id)"
